    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='category', to='apiart.category', verbose_name='Название Категории')),
            ],
            options={
                'ordering': ('name',),
            },
